...
createdAt DATETIME2 NOT NULL DEFAULT SYSDATETIME(),        --建立時間
updatedAt DATETIME2 NOT NULL DEFAULT SYSDATETIME(),        --更新時間
admStatus TINYINT NOT NULL DEFAULT 1                       --管理員狀態
);
...
--============BUILD TABLE==============
/* =========================================================
   1) 建立 maintenanceInformation & maintenanceStaff & maintenanceSchedule & maintenanceLog 
   ========================================================= */
...
VALUES
-- 1~5: 已完成的訂單 (同點歸還)
(1, NULL, 'SN-2025001', 1, , '2024-10-01 10:00:00', '2024-11-01 11:00:00', 3, N'已完成', 100, 100, 100, 'CreditCard', 'AB-12345678', '/AB12345', 0, NULL),
