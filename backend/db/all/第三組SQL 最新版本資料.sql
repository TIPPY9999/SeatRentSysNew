...
VALUES
    (N'置物椅-A01', N'E椅', 11, SYSDATETIME(), '000', DEFAULT),
    (N'置物椅-A01', N'E椅', 11, SYSDATETIME(), '001', DEFAULT),
    (N'置物椅-A02', N'E椅', 11, SYSDATETIME(), '002', DEFAULT),
    (N'置物椅-B01', N'E椅', 12, SYSDATETIME(), '003', DEFAULT),
    (N'置物椅-B02', N'E椅', 12, SYSDATETIME(), '004', DEFAULT),
    (N'基本椅-C01', N'B椅', 13, SYSDATETIME(), '005', DEFAULT),
    (N'基本椅-C02', N'B椅', 13, SYSDATETIME(), '006', DEFAULT),
    (N'置物椅-D01', N'E椅', 14, SYSDATETIME(), '007', DEFAULT),
    (N'置物椅-D02', N'E椅', 14, SYSDATETIME(), '008', DEFAULT),
    (N'基本椅-E01', N'E椅', 15, SYSDATETIME(), '009', DEFAULT),
    (N'基本椅-F01', N'B椅', 16, SYSDATETIME(), '010', DEFAULT),
    (N'基本椅-G01', N'B椅', 17, SYSDATETIME(), '011', DEFAULT),
    (N'置物椅-H01', N'E椅', 18, SYSDATETIME(), '012', DEFAULT),
    (N'置物椅-I01', N'E椅', 19, SYSDATETIME(), '013', DEFAULT),
    (N'置物椅-J01', N'E椅', 20, SYSDATETIME(), '014', DEFAULT),
    (N'置物椅-A01', N'E椅', 1, SYSDATETIME(), '100', DEFAULT),
    (N'置物椅-A01', N'E椅', 1, SYSDATETIME(), '101', DEFAULT),
    (N'置物椅-A02', N'E椅', 1, SYSDATETIME(), '102', DEFAULT),
    (N'置物椅-B01', N'E椅', 2, SYSDATETIME(), '103', DEFAULT),
    (N'置物椅-B02', N'E椅', 2, SYSDATETIME(), '104', DEFAULT),
    (N'基本椅-C01', N'B椅', 3, SYSDATETIME(), '105', DEFAULT),
    (N'基本椅-C02', N'B椅', 3, SYSDATETIME(), '106', DEFAULT),
    (N'置物椅-D01', N'E椅', 4, SYSDATETIME(), '107', DEFAULT),
    (N'置物椅-D02', N'E椅', 4, SYSDATETIME(), '108', DEFAULT),
    (N'基本椅-E01', N'E椅', 5, SYSDATETIME(), '109', DEFAULT),
    (N'基本椅-F01', N'B椅', 6, SYSDATETIME(), '110', DEFAULT),
    (N'基本椅-G01', N'B椅', 7, SYSDATETIME(), '111', DEFAULT),
    (N'置物椅-H01', N'E椅', 8, SYSDATETIME(), '112', DEFAULT),
    (N'置物椅-I01', N'E椅', 9, SYSDATETIME(), '113', DEFAULT),
    (N'置物椅-J01', N'E椅', 10, SYSDATETIME(), '114', DEFAULT),
    (N'備用設備-Z99', N'S椅', NULL, SYSDATETIME(), '999', DEFAULT);
--=========================================光宇 TEST DATA  END===================================
...
VALUES
    -- 1~5: 已完成的訂單 (同點歸還)
    (1, NULL, '001', 1, 9, '2021-03-12 10:00:00', '2021-03-12 13:00:00', 3, N'已完成', 100, 100, 100, 'CreditCard', 'AB-12345678', '/AB12345', 0, NULL),
    (2, 1, '003', 2, 2, '2021-11-15 12:30:00', '2021-11-15 15:30:00', 3, N'已完成', 50, 45, 45, 'LinePay', 'AB-12345679', '/CD67890', 0, NULL),
    (3, NULL, '005', 3, 3, '2022-05-20 09:00:00', '2022-05-20 13:00:00', 4, N'已完成', 300, 300, 300, 'Cash', 'AB-12345680', NULL, 0, NULL),
    (4, NULL, '007', 4, 4, '2022-08-10 14:00:00', '2022-08-10 18:00:00', 4, N'已完成', 50, 50, 50, 'ApplePay', 'AB-12345681', '/EF11223', 0, NULL),
    ...
    (3, NULL, '007', 4, NULL, DATEADD(MINUTE, -30, SYSDATETIME()), NULL, NULL, N'租借中', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
    (2, NULL, '011', 7, NULL, DATEADD(HOUR, -1, SYSDATETIME()), NULL, NULL, N'租借中', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
    (4, NULL, '010', 6, NULL, DATEADD(HOUR, -2, SYSDATETIME()), NULL, NULL, N'租借中', NULL, NULL, NULL, NULL, NULL, NULL, 0, N'長時間使用'),
    (1, NULL, '008', 4, NULL, DATEADD(MINUTE, -10, SYSDATETIME()), NULL, NULL, N'租借中', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),

    -- 16~18: 異常或違規紀錄
    (1, NULL, '006', 3, 3, '2021-07-01 10:00:00', '2021-07-01 14:00:00', 4, N'已完成', 400, 400, 400, 'Cash', 'AB-12345688', NULL, 1, N'超時歸還'),
    (7, NULL, '004', 2, NULL, '2022-10-05 09:00:00', NULL, NULL, N'未歸還', 0, 0, 0, NULL, NULL, NULL, 2, N'惡意遺失'),
    (8, NULL, '012', 8, 8, '2023-03-20 11:00:00', '2023-03-20 11:10:00', 1, N'已取消', 0, 0, 0, NULL, NULL, NULL, 0, N'設備故障取消'),

    -- 19~20: 跨日租借
    (9, NULL, '014', 10, 10, '2024-11-20 23:00:00', '2024-11-21 02:00:00', 3, N'已完成', 200, 200, 200, 'CreditCard', 'AB-12345689', NULL, 0, N'跨日租借'),
    (2, 5, '001', 1, 2, '2025-01-10 23:50:00', '2025-01-11 01:50:00', 2, N'已完成', 50, 40, 40, 'LinePay', 'AB-12345690', NULL, 0, NULL),
    ...
    (1, 1, '003', 2, 2, '2022-11-01 12:30:00', '2022-11-01 13:30:00', 1, N'已完成', 50, 45, 45, 'LinePay', 'AB-12345679', '/CD67890', 0, NULL),
    (1, NULL, '005', 3, 3, '2023-06-06 09:00:00', '2023-06-06 11:00:00', 2, N'已完成', 300, 300, 300, 'Cash', 'AB-12345680', NULL, 0, NULL),
    (1, NULL, '007', 4, 4, '2024-02-02 14:00:00', '2024-02-02 15:00:00', 1, N'已完成', 50, 50, 50, 'ApplePay', 'AB-12345681', '/EF11223', 0, NULL),
    (5, 2, '001', 1, 1, '2025-01-08 18:00:00', '2025-01-08 20:00:00', 2, N'已完成', 100, 80, 80, 'CreditCard', 'AB-12345682', NULL, 0, NULL),
    (3, NULL, '009', 5, 6, '2021-05-05 10:00:00', '2021-05-05 11:30:00', 1, N'已完成', 150, 150, 150, 'LinePay', 'AB-12345683', '/GH33445', 0, N'甲租乙還'),
    (3, NULL, '011', 7, 8, '2022-10-13 15:00:00', '2022-10-13 18:00:00', 3, N'已完成', 100, 100, 100, 'Cash', 'AB-12345684', NULL, 0, NULL),
    ...
    (10, NULL, '004', 2, 4, '2025-01-09 13:00:00', '2025-01-09 15:00:00', 2, N'已完成', 80, 80, 80, 'ApplePay', 'AB-12345687', '/KL77889', 0, NULL),
    ...
    (8, NULL, '015', 3, 4, '2021-05-12 10:00:00', '2021-05-12 14:00:00', 4, N'已完成', 200, 200, 200, 'ApplePay', 'BK-20210003', NULL, 0, N'甲租乙還'),
    ...
    (7, NULL, '005', 3, 3, '2021-12-31 22:00:00', '2022-01-01 02:00:00', 4, N'已完成', 200, 200, 200, 'CreditCard', 'BK-20210011', NULL, 0, N'跨日租借'),
    (5, NULL, '011', 8, 8, '2021-04-18 10:00:00', '2021-04-18 10:15:00', 1, N'已取消', 0, 0, 0, NULL, NULL, NULL, 0, N'臨時取消'),

    -- 2022 年資料 (12筆)
    (1, NULL, '009', 5, 5, '2022-01-20 10:00:00', '2022-01-20 12:00:00', 2, N'已完成', 100, 100, 100, 'LinePay', 'BK-20220001', '/BB222', 0, NULL),
    (3, 4, '013', 9, 10, '2022-02-14 17:00:00', '2022-02-14 19:00:00', 2, N'已完成', 100, 80, 80, 'ApplePay', 'BK-20220002', NULL, 0, N'甲租乙還'),
    (10, NULL, '006', 4, 4, '2022-03-30 08:30:00', '2022-03-30 11:30:00', 3, N'已完成', 150, 150, 150, 'CreditCard', 'BK-20220003', NULL, 0, NULL),
    (2, NULL, '002', 1, 1, '2022-04-12 14:00:00', '2022-04-12 16:00:00', 2, N'已完成', 100, 100, 100, 'Cash', 'BK-20220004', NULL, 0, NULL),
    (6, 1, '011', 7, 7, '2022-05-05 10:00:00', '2022-05-05 13:00:00', 3, N'已完成', 150, 135, 135, 'JKOPay', 'BK-20220005', '/JJ888', 0, NULL),
    (8, NULL, '001', 1, 3, '2022-06-20 15:00:00', '2022-06-20 18:00:00', 3, N'已完成', 150, 150, 150, 'CreditCard', 'BK-20220006', NULL, 0, N'甲租乙還'),
    (4, NULL, '004', 2, 2, '2022-07-07 09:00:00', '2022-07-07 10:30:00', 2, N'已完成', 100, 100, 100, 'ApplePay', 'BK-20220007', '/AA001', 0, NULL),
    (9, NULL, '015', 3, 3, '2022-08-15 12:00:00', '2022-08-15 15:00:00', 3, N'已完成', 150, 150, 150, 'Cash', 'BK-20220008', NULL, 0, NULL),
    (5, 2, '008', 4, 1, '2022-09-22 18:00:00', '2022-09-22 21:00:00', 3, N'已完成', 150, 120, 120, 'LinePay', 'BK-20220009', NULL, 0, N'甲租乙還'),
    (7, NULL, '007', 6, 6, '2022-10-10 10:00:00', '2022-10-10 14:00:00', 4, N'已完成', 200, 200, 200, 'CreditCard', 'BK-20220010', '/MM123', 1, N'逾時'),
    (1, NULL, '012', 8, 8, '2022-11-11 11:11:00', '2022-11-11 13:11:00', 2, N'已完成', 100, 100, 100, 'JKOPay', 'BK-20220011', NULL, 0, NULL),
    (2, NULL, '010', 5, NULL, '2022-12-20 14:00:00', NULL, NULL, N'未歸還', 0, 0, 0, NULL, NULL, NULL, 2, N'遺失'),
    ...
    (2, NULL, '004', 2, 2, '2023-09-15 11:00:00', '2023-09-15 13:00:00', 2, N'已完成', 100, 100, 100, 'Cash', 'BK-20230009', NULL, 0, NULL),
    ...
    (8, 1, '010', 5, 2, '2024-02-14 13:00:00', '2024-02-14 16:00:00', 3, N'已完成', 150, 130, 130, 'LinePay', 'BK-20240002', '/UU111', 0, N'甲租乙還'),
    (10, NULL, '005', 3, 3, '2024-03-20 09:00:00', '2024-03-20 11:00:00', 2, N'已完成', 100, 100, 100, 'ApplePay', 'BK-20240003', NULL, 0, NULL),
    (3, NULL, '012', 8, 8, '2024-04-05 15:00:00', '2024-04-05 18:00:00', 3, N'已完成', 150, 150, 150, 'CreditCard', 'BK-20240004', NULL, 0, NULL),
    (6, 4, '009', 5, 5, '2024-05-12 10:00:00', '2024-05-12 12:00:00', 2, N'已完成', 100, 80, 80, 'JKOPay', 'BK-20240005', '/RR444', 0, NULL),
    (1, NULL, '001', 1, 1, '2024-06-18 08:30:00', '2024-06-18 10:30:00', 2, N'已完成', 100, 100, 100, 'LinePay', 'BK-20240006', NULL, 0, NULL),
    (9, NULL, '014', 10, 10, '2024-07-20 19:00:00', '2024-07-20 22:00:00', 3, N'已完成', 150, 150, 150, 'ApplePay', 'BK-20240007', NULL, 0, NULL),
    (2, 2, '011', 7, 7, '2024-08-30 14:00:00', '2024-08-30 16:00:00', 2, N'已完成', 100, 90, 90, 'CreditCard', 'BK-20240008', '/EE555', 0, NULL),
    (4, NULL, '003', 2, 6, '2024-09-15 10:00:00', '2024-09-15 13:00:00', 3, N'已完成', 150, 150, 150, 'Cash', 'BK-20240009', NULL, 0, N'甲租乙還'),
    (7, NULL, '008', 4, 4, '2024-10-10 09:00:00', '2024-10-10 11:00:00', 2, N'已完成', 100, 100, 100, 'LinePay', 'BK-20240010', NULL, 0, NULL),
    ...
    -- 2025 年資料 (12筆)
    (1, 1, '001', 1, 1, '2025-01-05 10:00:00', '2025-01-05 12:00:00', 2, N'已完成', 100, 80, 80, 'LinePay', 'BK-20250001', '/ZZ111', 0, NULL),
    (3, NULL, '010', 5, 5, '2025-01-10 14:00:00', '2025-01-10 16:00:00', 2, N'已完成', 100, 100, 100, 'CreditCard', 'BK-20250002', NULL, 0, NULL),
    (6, NULL, '005', 3, 4, '2025-01-15 09:00:00', '2025-01-15 12:00:00', 3, N'已完成', 150, 150, 150, 'Cash', 'BK-20250003', NULL, 0, N'甲租乙還'),
    (8, NULL, '012', 8, 8, '2025-01-18 15:00:00', '2025-01-18 18:00:00', 3, N'已完成', 150, 150, 150, 'ApplePay', 'BK-20250004', NULL, 0, NULL),
    (10, 2, '003', 2, 2, '2025-01-20 10:00:00', '2025-01-20 12:00:00', 2, N'已完成', 100, 90, 90, 'LinePay', 'BK-20250005', '/TT666', 0, NULL),
    (2, NULL, '014', 10, 10, '2025-01-22 19:00:00', '2025-01-22 21:00:00', 2, N'已完成', 100, 100, 100, 'JKOPay', 'BK-20250006', NULL, 0, NULL),
    (4, NULL, '008', 4, 4, '2025-01-25 08:30:00', '2025-01-25 10:30:00', 2, N'已完成', 100, 100, 100, 'CreditCard', 'BK-20250007', NULL, 0, NULL),
    (7, 5, '002', 1, 1, '2025-01-26 13:00:00', '2025-01-26 15:00:00', 2, N'已完成', 100, 90, 90, 'ApplePay', 'BK-20250008', '/WW888', 0, NULL),
    (9, NULL, '015', 3, 3, '2025-01-27 10:00:00', '2025-01-27 12:00:00', 2, N'已完成', 100, 100, 100, 'Cash', 'BK-20250009', NULL, 0, NULL),
    (1, NULL, '007', 6, 6, '2025-01-28 14:00:00', '2025-01-28 17:00:00', 3, N'已完成', 150, 150, 150, 'LinePay', 'BK-20250010', NULL, 0, NULL),
    (5, NULL, '006', 4, 4, '2025-01-29 09:00:00', '2025-01-29 11:00:00', 2, N'已完成', 100, 100, 100, 'CreditCard', 'BK-20250011', NULL, 0, NULL),
    (2, NULL, '011', 7, 7, '2025-01-30 15:00:00', '2025-01-30 18:00:00', 3, N'已完成', 150, 150, 150, 'JKOPay', 'BK-20250012', NULL, 0, NULL);
--SQL VIEWS
USE [SeatRentSys];
GO
