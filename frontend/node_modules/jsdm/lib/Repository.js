...
function Repository(className) {
    ...
    this.create = function(data, callback) {
        ...
        this._create(data, function(err, aggobj) {
            if (err) {
                ...
                self._publish(className + ".*.create", data);
    ...
    this.remove = function(id) {
        cache[id] = false;
        this._publish(this.className + "." + id + ".remove");
        this._publish(this.className + ".*.remove", id);
    ...
    this.loopClear = function loopClear() {
        setTimeout(function() {
            cache = {}
            loopClear();
        }, self.clearTime);
